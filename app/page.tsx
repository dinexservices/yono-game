...
export const metadata: Metadata = {
  title: `${SITE_NAME} – Download Yono Rummy, Slots & Top Earning Apps 2026`,
  description:
    "Discover 50+ Yono earning apps — compare signup bonuses, min withdrawal limits & user ratings. Find the best Yono Rummy, Slots & casino apps, updated daily.",
  ...
  openGraph: {
    ...
    url: SITE_URL,
    siteName: SITE_NAME,
    title: `${SITE_NAME} – Yono Rummy, Slots & Earning Apps`,
    description:
      "Browse 50+ Yono earning apps with bonuses, ratings & direct APK download links — updated daily on All Yono Games.",
    images: [{ url: `${SITE_URL}/og-image.png`, width: 1200, height: 630, alt: SITE_NAME }],
  },
  twitter: {
    card: "summary_large_image",
    title: `${SITE_NAME} – Best Yono Earning Apps 2026`,
    description: "Compare & download the top Yono Rummy, Slots & casino apps with the highest signup bonuses.",
